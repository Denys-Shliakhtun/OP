...
int main()
{
    ...
    float element = 1, S = 1, element_p, diff;      //ініціалізація елемента і суми, оголошення попереднього елемента та різниці елементів
    ...
    } while (diff > eps); //цикл виконується, поки модуль різниці поточного елемента і минулого більший або рівний за задану точність
